...
![alt text](https://github.com/mark-grayson/rpi4/blob/main/RPI_Passpoint.png "Raspberry PI with USB dongle")
...
The onboard Wi-Fi from the Broadcom chip does not support IEEE 802.11u
and so this demo uses a Realtek RTL8812 Wi-Fi Dongle, a TP-Link AC1300. 

Other dongles are listed here: https://kalitut.com/rtl8812au-wifi-usb-adapter/

## Update and Upgrade you Raspberry PI
...
Follow the instructions here: https://github.com/fastoe/RTL8812BU_for_Raspbian

NOTE, however, the demo uses kernel 5.10, and so follow the resolution to the issue listed here:
https://github.com/fastoe/RTL8812BU_for_Raspbian/issues/8
...
Check that PI's default wpa_supplicant isn't running on wlan1
...
If the default /etc/wpa_supplicant is running (as shown above), kill the wlan1 process
 ...
 ### Start wpa_suplicant on the dongle
...
Configure EAP-TLS RADIUS server. Its recommended you use FreeRADIUS v2.3 so follow the instructions here:

https://networkradius.com/packages/#fr32-ubuntu

## Set up CA, Server and Client Certificates

On the RADIUS server, edit the configuration in the /certs folder.
Edit the policy line:


    - policy           = policy_match
    + policy           = policy_anything

Edit the ca.cnf, server.cnf and client.cnf as you see fit. Example configurations are included in this post: https://wiki.alpinelinux.org/wiki/FreeRadius_EAP-TLS_configuration.

Run the script to generate the CA, Server and Client sertificates
...
## Set up EAP-TLS certifcates and trust anchor on the Raspberry PI

We are first going to use the intergated wlan0 to test EAP-TLS, before then using the certificate as a Passpoint credential.
...
Now add the CA onto the the ca-certificates.crt based list of trusted CAs:

    $ sudo apt-get install -y ca-certificates
    $ sudo update-ca-certificates

You can check that it has been added by running the following command. It should be last entry in the list.

    $ awk -v cmd='openssl x509 -noout -subject' '
        /BEGIN/{close(cmd)};{print | cmd}' < /etc/ssl/certs/ca-certificates.crt

## Configure the certifcates and trust anchor as EAP credentials on the Raspberry PI
...
Fix a known problem with Raspberry PI with 4-way handshake (https://forums.raspberrypi.com/viewtopic.php?t=253567).
...
Now enable the wpa supplicant via the CLI
...
Re-initiatize the WLAN interface
    ...
    <3>CTRL-EVENT-EAP-PEER-CERT depth=1 subject='/C=GB/ST=Berkshire/L=Maidenhead/O=OR4IoT Test CA/CN=OR4IoT Proof of Concept test CA' cert=
    ...
    <3>CTRL-EVENT-EAP-PEER-CERT depth=0 subject='/C=GB/ST=Berkshire/O=OpenRoaming for IoT PoC/CN=Server certificate for OR4IoT PoC' cert=
...
You see how the credential block is used to pupulate the RADIUS Access-Request from the RADIUS logs:
